...
> Historical planning artifact. Paths, phase assumptions, and acceptance checkboxes below describe the original proposal. Use the [repository README](../../README.md), current source, and [production audit](production-audit-2026-09-06.md) for the implemented state.
